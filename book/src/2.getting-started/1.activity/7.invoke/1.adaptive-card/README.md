...
The name of the invoke activity for Adaptive Cards is `adaptiveCard/action`. However, the `@teams.sdk/api` package includes an alias for this invoke activity, `card.action`.
