...
export class TeamsAppClient {
  protected baseUrl = '/teams/{team-id}/channels/{channel-id}/tabs/{teamsTab-id}/teamsApp';
   ...
   */
  async get(
    params?: Endpoints['GET /teams/{team-id}/channels/{channel-id}/tabs/{teamsTab-id}/teamsApp']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /teams/{team-id}/channels/{channel-id}/tabs/{teamsTab-id}/teamsApp']['response']
      );
  }
}
