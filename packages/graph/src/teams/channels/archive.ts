...
export class ArchiveClient {
   ...
   */
  async create(
    body: Endpoints["POST /teams/{team-id}/channels/{channel-id}/archive"]["body"],
    params?: Endpoints["POST /teams/{team-id}/channels/{channel-id}/archive"]["parameters"],
  ) {
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["POST /teams/{team-id}/channels/{channel-id}/archive"]["response"],
      );
  }
}
