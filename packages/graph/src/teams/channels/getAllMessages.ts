...
export class GetAllMessagesClient {
   ...
   */
  async get(params?: Endpoints['GET /teams/{team-id}/channels/getAllMessages()']['parameters']) {
    ...
    return this.http
      .get(url)
      .then(
        (res) => res.data as Endpoints['GET /teams/{team-id}/channels/getAllMessages()']['response']
      );
  }
}
