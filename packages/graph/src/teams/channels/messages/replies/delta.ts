...
export class DeltaClient {
  ...
  /**
   * `GET /teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints["GET /teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/delta()"]["parameters"],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/delta()"]["response"],
      );
  }
}
