...
export class GetAllRetainedMessagesClient {
   ...
   */
  async get(
    params?: Endpoints["GET /teams/{team-id}/channels/getAllRetainedMessages()"]["parameters"],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /teams/{team-id}/channels/getAllRetainedMessages()"]["response"],
      );
  }
}
