...
export class MembersClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /teams/{team-id}/primaryChannel/members/{conversationMember-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /teams/{team-id}/primaryChannel/members']['parameters']) {
    const url = getInjectedUrl(
      '/teams/{team-id}/primaryChannel/members',
      [
