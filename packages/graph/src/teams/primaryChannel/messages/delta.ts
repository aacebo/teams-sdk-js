...
export class DeltaClient {
  protected baseUrl = "/teams/{team-id}/primaryChannel/messages/delta";
   ...
   */
  async get(
    params?: Endpoints["GET /teams/{team-id}/primaryChannel/messages/delta()"]["parameters"],
  ) {
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /teams/{team-id}/primaryChannel/messages/delta()"]["response"],
      );
  }
}
