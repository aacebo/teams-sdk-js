...
export class DeltaClient {
  protected baseUrl = '/teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/delta';
  ...
  /**
   * `GET /teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/delta()']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/delta()']['response']
      );
  }
}
