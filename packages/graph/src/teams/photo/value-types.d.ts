...
export interface Endpoints {
   ...
   */
  'DELETE /teams/{team-id}/photo/$value': Operation<'/teams/{team-id}/photo/$value', 'delete'>;
  /**
...
For example, if the user uploads a photo that is 504x504 pixels, all but the 648x648 size of the photo is available for download.
   */
  'GET /teams/{team-id}/photo/$value': Operation<'/teams/{team-id}/photo/$value', 'get'>;
  /**
   ...
   */
  'PUT /teams/{team-id}/photo/$value': Operation<'/teams/{team-id}/photo/$value', 'put'>;
}
