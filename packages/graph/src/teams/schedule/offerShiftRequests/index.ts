...
export class OfferShiftRequestsClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /teams/{team-id}/schedule/offerShiftRequests/{offerShiftRequest-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /teams/{team-id}/schedule/offerShiftRequests']['parameters']) {
    const url = getInjectedUrl(
      '/teams/{team-id}/schedule/offerShiftRequests',
      [
