...
export class CallRecordsClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /communications/callRecords/{callRecord-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /communications/callRecords']['parameters']) {
    const url = getInjectedUrl(
      '/communications/callRecords',
      [
   ...
   */
  async get(params?: Endpoints['GET /communications/callRecords/{callRecord-id}']['parameters']) {
    const url = getInjectedUrl(
      '/communications/callRecords/{callRecord-id}',
      [
        { name: '$select', in: 'query' },
