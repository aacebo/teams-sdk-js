...
export class RestorePointsClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /solutions/backupRestore/restorePoints/{restorePoint-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /solutions/backupRestore/restorePoints']['parameters']) {
    const url = getInjectedUrl(
      '/solutions/backupRestore/restorePoints',
      [
