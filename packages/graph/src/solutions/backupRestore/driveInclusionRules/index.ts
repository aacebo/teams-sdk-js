...
export class DriveInclusionRulesClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /solutions/backupRestore/driveInclusionRules/{driveProtectionRule-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /solutions/backupRestore/driveInclusionRules']['parameters']) {
    const url = getInjectedUrl(
      '/solutions/backupRestore/driveInclusionRules',
      [
