...
export class SiteProtectionUnitsClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /solutions/backupRestore/siteProtectionUnits/{siteProtectionUnit-id}']['body'],
   ...
   */
  async list(params?: Endpoints['GET /solutions/backupRestore/siteProtectionUnits']['parameters']) {
    const url = getInjectedUrl(
      '/solutions/backupRestore/siteProtectionUnits',
      [
