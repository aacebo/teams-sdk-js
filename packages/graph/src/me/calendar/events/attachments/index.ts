...
export class AttachmentsClient {
   ...
   */
  async list(params?: Endpoints['GET /me/calendar/events/{event-id}/attachments']['parameters']) {
    const url = getInjectedUrl(
      '/me/calendar/events/{event-id}/attachments',
      [
    ...
    return this.http
      .get(url)
      .then(
        (res) => res.data as Endpoints['GET /me/calendar/events/{event-id}/attachments']['response']
      );
  }
