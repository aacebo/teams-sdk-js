...
export class AttachmentsClient {
  ...
  /**
   * `DELETE /me/calendar/events/{event-id}/instances/{event-id1}/attachments/{attachment-id}`
   *
   */
  async delete(
  ...
  /**
   * `GET /me/calendar/events/{event-id}/instances/{event-id1}/attachments`
   *
  ...
  /**
   * `GET /me/calendar/events/{event-id}/instances/{event-id1}/attachments/{attachment-id}`
   *
   * The collection of FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
   */
  async get(
  ...
  /**
   * `POST /me/calendar/events/{event-id}/instances/{event-id1}/attachments`
   *
   */
  async create(
