...
export class CancelClient {
  protected baseUrl = '/me/calendar/events/{event-id}/instances/{event-id1}/cancel';
...
the organizer send a custom message to the attendees about the cancellation.
   */
  async create(
    body: Endpoints['POST /me/calendar/events/{event-id}/instances/{event-id1}/cancel']['body'],
    params?: Endpoints['POST /me/calendar/events/{event-id}/instances/{event-id1}/cancel']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /me/calendar/events/{event-id}/instances/{event-id1}/cancel']['response']
      );
  }
}
