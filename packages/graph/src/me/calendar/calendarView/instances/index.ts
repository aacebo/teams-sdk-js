...
export class InstancesClient {
  protected baseUrl = "\me\calendar\calendarView\{event-id}\instances";
  ...
  /**
   * `\me\calendar\calendarView\{event-id}\instances\{event-id1}\dismissReminder`
   *
  ...
  /**
   * `\me\calendar\calendarView\{event-id}\instances\{event-id1}\forward`
   *
  ...
  /**
   * `GET /me/calendar/calendarView/{event-id}/instances`
   *
   * The occurrences of a recurring series, if the event is a series master. This property includes occurrences that are part of the recurrence pattern, and exceptions that have been modified, but does not include occurrences that have been cancelled from the series. Navigation property. Read-only. Nullable.
   */
  async get(
    params?: Endpoints["GET /me/calendar/calendarView/{event-id}/instances"]["parameters"],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /me/calendar/calendarView/{event-id}/instances"]["response"],
      );
  }

  /**
   * `GET /me/calendar/calendarView/{event-id}/instances/{event-id1}`
   *
   * The occurrences of a recurring series, if the event is a series master. This property includes occurrences that are part of the recurrence pattern, and exceptions that have been modified, but does not include occurrences that have been cancelled from the series. Navigation property. Read-only. Nullable.
   */
  async get$1(
    params?: Endpoints["GET /me/calendar/calendarView/{event-id}/instances/{event-id1}"]["parameters"],
    config?: http.RequestConfig,
  ) {
    const url = getInjectedUrl(
      "/me/calendar/calendarView/{event-id}/instances/{event-id1}",
      [
        { name: "startDateTime", in: "query" },
        { name: "endDateTime", in: "query" },
        { name: "$select", in: "query" },
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /me/calendar/calendarView/{event-id}/instances/{event-id1}"]["response"],
      );
  }
}
