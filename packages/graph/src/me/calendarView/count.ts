...
export class CountClient {
  ...
  /**
   * `GET /me/calendarView/$count`
   *
   */
  async get(params?: Endpoints['GET /me/calendarView/$count']['parameters']) {
    ...
    return this.http
      .get(url)
      .then((res) => res.data as Endpoints['GET /me/calendarView/$count']['response']);
  }
}
