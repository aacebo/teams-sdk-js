...
export class GetAllMessagesClient {
  protected baseUrl = '/me/chats/getAllMessages';
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/getAllMessages()']['parameters'],
    ...
    return this.http
      .get(url, config)
      .then((res) => res.data as Endpoints['GET /me/chats/getAllMessages()']['response']);
  }
}
