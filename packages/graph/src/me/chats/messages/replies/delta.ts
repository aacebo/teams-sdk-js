...
export class DeltaClient {
  protected baseUrl = '/me/chats/{chat-id}/messages/{chatMessage-id}/replies/delta';
  ...
  /**
   * `GET /me/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()']['response']
      );
  }
}
