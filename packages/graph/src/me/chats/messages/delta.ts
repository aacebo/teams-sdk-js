...
export class DeltaClient {
  protected baseUrl = '/me/chats/{chat-id}/messages/delta';
  ...
  /**
   * `GET /me/chats/{chat-id}/messages/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/{chat-id}/messages/delta()']['parameters'],
    ...
    return this.http
      .get(url, config)
      .then((res) => res.data as Endpoints['GET /me/chats/{chat-id}/messages/delta()']['response']);
  }
}
