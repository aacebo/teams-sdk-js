...
export class TeamsAppClient {
  protected baseUrl = '/me/chats/{chat-id}/installedApps/{teamsAppInstallation-id}/teamsApp';
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/{chat-id}/installedApps/{teamsAppInstallation-id}/teamsApp']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/chats/{chat-id}/installedApps/{teamsAppInstallation-id}/teamsApp']['response']
      );
  }
}
