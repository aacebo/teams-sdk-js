...
export class GetAllRetainedMessagesClient {
  protected baseUrl = '/me/chats/getAllRetainedMessages';
  ...
  /**
   * `GET /me/chats/getAllRetainedMessages()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/getAllRetainedMessages()']['parameters'],
    ...
    return this.http
      .get(url, config)
      .then((res) => res.data as Endpoints['GET /me/chats/getAllRetainedMessages()']['response']);
  }
}
