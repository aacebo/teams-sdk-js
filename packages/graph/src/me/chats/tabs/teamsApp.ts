...
export class TeamsAppClient {
  protected baseUrl = '/me/chats/{chat-id}/tabs/{teamsTab-id}/teamsApp';
   ...
   */
  async get(
    params?: Endpoints['GET /me/chats/{chat-id}/tabs/{teamsTab-id}/teamsApp']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/chats/{chat-id}/tabs/{teamsTab-id}/teamsApp']['response']
      );
  }
}
