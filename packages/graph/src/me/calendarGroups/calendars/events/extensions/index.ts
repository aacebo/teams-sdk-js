...
export class ExtensionsClient {
   ...
   */
  async delete(
    body: Endpoints["DELETE /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}"]["body"],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["DELETE /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}"]["response"],
      );
  }
  ...
  async list(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions"]["response"],
      );
  }
  ...
  async get(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}"]["response"],
      );
  }
  ...
  async update(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["PATCH /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}"]["response"],
      );
  }
  ...
  async create(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["POST /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/extensions"]["response"],
      );
  }
}
