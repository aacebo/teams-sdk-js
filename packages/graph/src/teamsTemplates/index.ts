...
export class TeamsTemplatesClient {
   ...
   */
  async delete(
    body: Endpoints['DELETE /teamsTemplates/{teamsTemplate-id}']['body'],
   ...
   *
   */
  async list(params?: Endpoints['GET /teamsTemplates']['parameters']) {
    const url = getInjectedUrl(
      '/teamsTemplates',
      [
   ...
   *
   */
  async get(params?: Endpoints['GET /teamsTemplates/{teamsTemplate-id}']['parameters']) {
    const url = getInjectedUrl(
      '/teamsTemplates/{teamsTemplate-id}',
      [
        { name: '$select', in: 'query' },
