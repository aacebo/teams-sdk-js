...
export class GetAllMessagesClient {
  protected baseUrl = '/teamwork/deletedTeams/{deletedTeam-id}/channels/getAllMessages';
  ...
  /**
   * `GET /teamwork/deletedTeams/{deletedTeam-id}/channels/getAllMessages()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /teamwork/deletedTeams/{deletedTeam-id}/channels/getAllMessages()']['parameters']
  ) {
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /teamwork/deletedTeams/{deletedTeam-id}/channels/getAllMessages()']['response']
      );
  }
}
