...
export class DeltaClient {
  protected baseUrl = '/users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies/delta';
  ...
  /**
   * `GET /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies/delta()']['response']
      );
  }
}
