...
export class DeltaClient {
  protected baseUrl = '/users/{user-id}/chats/{chat-id}/messages/delta';
  ...
  /**
   * `GET /users/{user-id}/chats/{chat-id}/messages/delta()`
   *
   ...
   */
  async get(
    params?: Endpoints['GET /users/{user-id}/chats/{chat-id}/messages/delta()']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /users/{user-id}/chats/{chat-id}/messages/delta()']['response']
      );
  }
}
