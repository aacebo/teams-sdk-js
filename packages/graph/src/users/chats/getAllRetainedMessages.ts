...
export class GetAllRetainedMessagesClient {
  protected baseUrl = '/users/{user-id}/chats/getAllRetainedMessages';
   ...
   */
  async get(
    params?: Endpoints['GET /users/{user-id}/chats/getAllRetainedMessages()']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /users/{user-id}/chats/getAllRetainedMessages()']['response']
      );
  }
}
