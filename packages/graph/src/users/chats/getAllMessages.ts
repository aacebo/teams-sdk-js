...
export class GetAllMessagesClient {
  protected baseUrl = '/users/{user-id}/chats/getAllMessages';
   ...
   */
  async get(
    params?: Endpoints['GET /users/{user-id}/chats/getAllMessages()']['parameters'],
    ...
    return this.http
      .get(url, config)
      .then(
        (res) => res.data as Endpoints['GET /users/{user-id}/chats/getAllMessages()']['response']
      );
  }
}
