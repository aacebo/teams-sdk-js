...
export interface Endpoints {
   ...
   */
  "GET /users/{user-id}/onlineMeetings/getAllTranscripts(meetingOrganizerUserId&#x3D;&#x27;@meetingOrganizerUserId&#x27;,startDateTime&#x3D;@startDateTime,endDateTime&#x3D;@endDateTime)": Operation<
