...
export class GetAllTranscriptsmeetingOrganizerUserIdmeetingOrganizerUserIdstartDateTimestartDateTimeendDateTimeendDateTimeClient {
  ...
  /**
   * `GET /users/{user-id}/onlineMeetings/getAllTranscripts(meetingOrganizerUserId&#x3D;&#x27;@meetingOrganizerUserId&#x27;,startDateTime&#x3D;@startDateTime,endDateTime&#x3D;@endDateTime)`
   *
   ...
   */
  async get(
    params?: Endpoints["GET /users/{user-id}/onlineMeetings/getAllTranscripts(meetingOrganizerUserId&#x3D;&#x27;@meetingOrganizerUserId&#x27;,startDateTime&#x3D;@startDateTime,endDateTime&#x3D;@endDateTime)"]["parameters"],
  ) {
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints["GET /users/{user-id}/onlineMeetings/getAllTranscripts(meetingOrganizerUserId&#x3D;&#x27;@meetingOrganizerUserId&#x27;,startDateTime&#x3D;@startDateTime,endDateTime&#x3D;@endDateTime)"]["response"],
      );
  }
}
